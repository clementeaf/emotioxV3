...
import { EmotionHierarchySelectorProps } from './types';
import { getClusterButtonClasses } from './utils';
      ...
      <div className="flex flex-col items-center space-y-2">
        ...
        <div className="w-full max-w-md">
          <button
            ...
            className={getClusterButtonClasses('advocacy', selectedCluster, 'w-full p-4 rounded-lg border-2 transition-all duration-200')}
          >
        ...
        <div className="w-full max-w-md">
          <button
            ...
            className={getClusterButtonClasses('recommendation', selectedCluster, 'w-full p-4 rounded-lg border-2 transition-all duration-200')}
          >
            <div className="flex items-center justify-between">
              <div className="text-left">
        ...
        <div className="w-full max-w-md">
          <button
            ...
            className={getClusterButtonClasses('attention', selectedCluster, 'w-full p-4 rounded-lg border-2 transition-all duration-200')}
          >
            <div className="flex items-center justify-between">
              <div className="text-left">
        ...
        <div className="w-full max-w-md">
          <button
            ...
            className={getClusterButtonClasses('destroying', selectedCluster, 'w-full p-4 rounded-lg border-2 transition-all duration-200')}
          >
            <div className="flex items-center justify-between">
              <div className="text-left">
