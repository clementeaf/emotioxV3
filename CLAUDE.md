...
- **Pendiente**: vista de resultados/analytics para Eye Tracking. Pendiente también: rendering en participant-frontend para Screener, Implicit Association y Eye Tracking.
