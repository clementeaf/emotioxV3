    ...
    return (
        <div className="h-full flex flex-col p-6 gap-6 overflow-hidden">
            ...
            <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col min-h-0 bg-gray-50/50 rounded-xl border border-gray-100 overflow-hidden">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center justify-between gap-2 mt-1">
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 text-xs bg-blue-50 text-blue-700 px-2.5 py-1.5 rounded-md hover:bg-blue-100 transition-colors font-medium flex-shrink-0"
                                                >
