...
export const MetricChartCard = ({ title, score, question, data, className }: MetricChartCardProps) => {
  const abbreviation = title === 'Customer Satisfaction' ? 'CSAT' :
      ...
      <div className="h-40">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data && data.length > 0 ? data : [
            { date: 'Jan', satisfied: 0, dissatisfied: 0 },
            { date: 'Feb', satisfied: 0, dissatisfied: 0 },
            { date: 'Mar', satisfied: 0, dissatisfied: 0 },
            { date: 'Apr', satisfied: 0, dissatisfied: 0 },
