...
export const HouseholdIncomeConfigModal: React.FC<HouseholdIncomeConfigModalProps> = ({
  ...
  return (
    <DemographicConfigModalBase
      ...
      quotasDescription="Configura cuotas específicas por nivel de ingresos. Cuando se alcance la cuota de un nivel, los participantes de ese nivel serán descalificados automáticamente."
      quotasInfoTitle="Cómo funcionan las cuotas:"
      quotasInfoItems={[
        'Cada nivel de ingresos puede tener su propia cuota (número absoluto o porcentaje)',
